...
#to set zero suppresion mode (software)
#export ZS_BASELINE=16
#export ZS_POLARITY=1
#where ZS_POLARITY<>0 : positive
#where ZS_POLARITY=0 : negative

rcdaq_client daq_define_runtype beam  /home/daq/brIKEN2019/rawdata/beam/beamrun%05d.evt
rcdaq_client daq_define_runtype preparation  /home/daq/brIKEN2019/rawdata/preparation/prerun%05d.evt
rcdaq_client daq_define_runtype calibration  /home/daq/brIKEN2019/rawdata/calibration/calibrun%05d.evt
...
#set run type
rcdaq_client daq_set_runtype calibration
