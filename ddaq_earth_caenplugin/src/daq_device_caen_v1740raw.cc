...
daq_device_caen_v1740raw::daq_device_caen_v1740raw(const int eventtype
...
daq_device_caen_v1740raw::~daq_device_caen_v1740raw()
{
...
int  daq_device_caen_v1740raw::init()
{
...
int daq_device_caen_v1740raw::put_data(const int etype, int * adr, const int length )
{
    //cout<<"put data"<<endl;
//    if ( _broken )
//    {
...
//    }
    ...
    if (ElapsedTime > 1000) {
        ...
        if (Nb == 0)
            ...
            printf("Reading board %d at %.2f MB/s (Trg Rate: %.2f Hz)\n", _boardnumber, ReadoutRate, TriggerRate);
...
int daq_device_caen_v1740raw::endrun()
{
...
void daq_device_caen_v1740raw::identify(std::ostream& os) const
{
    CAEN_DGTZ_BoardInfo_t       BoardInfo;
}


int daq_device_caen_v1740raw::max_length(const int etype) const
{
...
// the rearm() function
int  daq_device_caen_v1740raw::rearm(const int etype)
{
    if ( _broken )
      {
        //      cout << __LINE__ << "  " << __FILE__ << " broken ";
...
//void daq_device_caen_v1740raw::addfifo(int fifobufin)
//{
//    fifobuf=fifobufin;
