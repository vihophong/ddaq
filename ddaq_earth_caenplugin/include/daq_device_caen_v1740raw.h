#ifndef __DAQ_DEVICE_CAEN_V1740RAW__
#define __DAQ_DEVICE_CAEN_V1740RAW__
...
class daq_device_caen_v1740raw: public  daq_device {

public:
    daq_device_caen_v1740raw(const int eventtype
               , const int subeventid
               , const int isdppmode = 0
               , const int boardid = 0
               , const int trigger = 1);

    ~daq_device_caen_v1740raw();
